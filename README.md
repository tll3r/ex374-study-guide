...
- **ex374-quiz.html** — A single-file, zero-dependency quiz game playable in any browser. Multiple choice, type-the-command, and flashcard modes with 100 questions across all objective areas.
